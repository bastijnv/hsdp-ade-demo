package se.philips.microservices.composite.patient;
...
import se.philips.microservices.util.MDCHystrixConcurrencyStrategy;

@SpringBootApplication
@EnableCircuitBreaker
@EnableDiscoveryClient
@ComponentScan({"se.philips.microservices.composite.patient", "se.philips.microservices.util"})
